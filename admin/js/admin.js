...
/* ==========================================
   ACTIVE SIDEBAR + REAL NAVIGATION
========================================== */

const navItems = document.querySelectorAll(".sidebar li[data-href]");
...
/* ==========================================
   AUTH GUARD (extra client-side safety net;
   the server also blocks these pages directly)
========================================== */
...
const deleteButtons = document.querySelectorAll(".delete-btn:not(#confirmDeleteBtn)");
...
/* ==========================================
   (Removed) a demo handler used to intercept every button
   labelled "Save..." and call preventDefault(), which silently
   blocked real form submissions (Add/Edit Product, Save Status, etc).
   Each page now wires its own save button explicitly.
========================================== */
