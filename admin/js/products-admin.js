...
async function loadProducts() {
    try {
        ...
        tableBody.innerHTML = `<tr><td colspan="7">Could not load products. Is the server running?</td></tr>`;
    }
}
...
function renderTable() {
    ...
    if (filtered.length === 0) {
        tableBody.innerHTML = `<tr><td colspan="7">No products found. Click "Add Product" to create one.</td></tr>`;
        return;
    }
